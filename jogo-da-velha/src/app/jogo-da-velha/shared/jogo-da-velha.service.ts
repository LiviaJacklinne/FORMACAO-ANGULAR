...
export class JogoDaVelhaService {
  ...
  private tabuleiro: any; // o tabuleiro é um array
  private numMovimentos: number; // num de movimento +9 =  empate
  private vitoria: any;

  // controle de quem vai jogar e de quem venceu
  ...
  /**
   * Exibe o tabuleiro. Quando clica no botão "Iniciar jogo"
   *
   * @return void
   */
  iniciarJogo(): void {
